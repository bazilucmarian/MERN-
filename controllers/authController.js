...
exports.signup = async (req, res, next) => {
  try {
    ...
    if (!email || !password) {
      return next(new ErrorHandler(400, "Please eneter an email and password"));
    }
    if (password.length < 8) {
      return next(
        new ErrorHandler(401, "Password must be at least 8 eight characters")
      );
    }
